  ...
  return (
    ...
    >
      ...
      >
        ...
        ></div>
        <div
          className="absolute bottom-20 right-20 w-40 h-40 bg-pink-500 rounded-full blur-3xl"
          style={{ contain: "layout" }}
        ></div>
        <div
          className="absolute top-40 right-40 w-24 h-24 bg-blue-500 rounded-full blur-3xl"
          style={{ contain: "layout" }}
        ></div>
      </div>
